...
impl EngineRegistry {
    ...
    pub fn with_defaults(client: Client) -> Self {
        ...
        // ── Original engines ──────────────────────────────
        // registry.register(Arc::new(Google::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Ask::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Bilibili::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(CratesIo::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Ebay::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Spotify::new(client.clone()))); // ERROR: needs API key
        ...
        // registry.register(Arc::new(Qwant::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(Vimeo::new(client.clone()))); // EMPTY
        registry.register(Arc::new(Unsplash::new(client.clone())));
        // registry.register(Arc::new(SemanticScholar::new(client.clone()))); // EMPTY
        registry.register(Arc::new(StackExchange::new(client.clone())));
        // registry.register(Arc::new(Freesound::new(client.clone()))); // ERROR: needs API key

        // ── Batch 5: More SearXNG translations ────────────
        // registry.register(Arc::new(LeetX::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(AcFun::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Fyyd::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Btdigg::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Ina::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(AnnasArchive::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(BaseSearch::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(Digbt::new(client.clone()))); // EMPTY

        // ── Batch 10: More SearXNG translations ───────────
        // registry.register(Arc::new(Geizhals::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(LiveSpace::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(MaterialIcons::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(SvgRepo::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Stract::new(client.clone()))); // EMPTY
        registry.register(Arc::new(Tagesschau::new(client.clone())));
        registry.register(Arc::new(VoidLinux::new(client.clone())));
        // registry.register(Arc::new(Rumble::new(client.clone()))); // EMPTY
        registry.register(Arc::new(Pinterest::new(client.clone())));
        // registry.register(Arc::new(PodcastIndex::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(SolidTorrents::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Searchcode::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(TokyoToshokan::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(DeviantArt::new(client.clone()))); // EMPTY
        registry.register(Arc::new(ThreeSixtySearchVideos::new(client.clone())));
        // registry.register(Arc::new(Sourcehut::new(client.clone()))); // EMPTY

        // ── Batch 17: More SearXNG translations ───────────
        // registry.register(Arc::new(Chinaso::new(client.clone()))); // EMPTY
        registry.register(Arc::new(FlickrNoapi::new(client.clone())));
        // registry.register(Arc::new(Ahmia::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Mojeek::new(client.clone()))); // EMPTY
        registry.register(Arc::new(GooglePlay::new(client.clone())));
        // registry.register(Arc::new(Yandex::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(BraveApi::new(client.clone(), None))); // ERROR: needs API key
        // registry.register(Arc::new(CoreEngine::new(client.clone(), None))); // ERROR: needs API key
        // registry.register(Arc::new(Springer::new(client.clone(), None))); // ERROR: needs API key
        registry.register(Arc::new(Ads::new(client.clone(), None)));
        // registry.register(Arc::new(Marginalia::new(client.clone(), None))); // ERROR: needs API key
        // registry.register(Arc::new(DuckDuckGoDefinitions::new(client.clone()))); // EMPTY
        registry.register(Arc::new(GoogleImages::new(client.clone())));
        // registry.register(Arc::new(GoogleScholar::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(GoogleVideos::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Discourse::new(client.clone(), "", None, None))); // EMPTY
        // registry.register(Arc::new(Invidious::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(Piped::new(client.clone(), "", ""))); // EMPTY
        // registry.register(Arc::new(MediaWikiEngine::new(client.clone(), ""))); // EMPTY
        ...
        //     None,
        // ))); // EMPTY
        // registry.register(Arc::new(Doku::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(RecollEngine::new(client.clone(), "", "", ""))); // EMPTY

        // ── Batch 23: Translation, dictionary, weather, maps, currency ─
        // Translation engines (configurable, disabled by default)
        // registry.register(Arc::new(LibreTranslate::new(client.clone(), "", None))); // EMPTY
        // registry.register(Arc::new(Lingva::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(DeepL::new(client.clone(), None))); // EMPTY
        // Dictionary & general engines (always enabled)
        // registry.register(Arc::new(DictZone::new(client.clone()))); // EMPTY
        registry.register(Arc::new(Wordnik::new(client.clone())));
        // registry.register(Arc::new(CurrencyConvert::new(client.clone()))); // EMPTY
        // Reverse image search
        // registry.register(Arc::new(TinEye::new(client.clone()))); // EMPTY
        // Map engines
        ...
        // registry.register(Arc::new(SearchcodeCode::new(client.clone()))); // EMPTY
        ...
        // registry.register(Arc::new(Reuters::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(ScanrStructures::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(Pdbe::new(client.clone()))); // EMPTY

        // ── Batch 26: MRS, SensCritique, Yahoo News, OpenClipart, UXWing, 1x ──
        // registry.register(Arc::new(Mrs::new(client.clone(), ""))); // EMPTY
        ...
        // registry.register(Arc::new(YoutubeApi::new(client.clone(), None))); // ERROR: needs API key
        registry.register(Arc::new(YoutubeNoapi::new(client.clone())));
        // registry.register(Arc::new(WolframAlphaApi::new(client.clone(), None))); // ERROR: needs API key
        // registry.register(Arc::new(WolframAlphaNoapi::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(AstrophysicsDataSystem::new(client.clone(), None))); // ERROR: needs API key
        ...
        // registry.register(Arc::new(Mozhi::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(Wttr::new(client.clone()))); // EMPTY
        registry.register(Arc::new(OpenMeteo::new(client.clone())));
        registry.register(Arc::new(Seznam::new(client.clone())));
        // registry.register(Arc::new(Startpage::new(client.clone()))); // EMPTY

        // ── Batch 30: Pexels, Pixiv, DDG Extra, 360 Search, YaCy, Torznab ──
        registry.register(Arc::new(DuckDuckGoExtra::new(client.clone())));
        // registry.register(Arc::new(Pexels::new(client.clone(), None))); // ERROR: needs API key
        registry.register(Arc::new(Pixiv::new(client.clone())));
        // registry.register(Arc::new(ThreeSixtySearch::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(Yacy::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(Torznab::new(client.clone(), "", None))); // EMPTY

        // ── Batch 31: Self-hosted, Wikidata, PDIA, SearXNG federation ──
        registry.register(Arc::new(Wikidata::new(client.clone())));
        // registry.register(Arc::new(PublicDomainImageArchive::new(client.clone()))); // EMPTY
        // registry.register(Arc::new(Solr::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(OpenSemantic::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(SearxEngine::new(client.clone(), ""))); // EMPTY
        // registry.register(Arc::new(TubeArchivist::new(client.clone(), "", None))); // EMPTY

        // ── Batch 32: AI/Cloud: Ollama, Cloudflare AI, Azure Search ──
        // registry.register(Arc::new(Ollama::new(client.clone(), "", None))); // EMPTY
        // registry.register(Arc::new(CloudflareAi::new(client.clone(), None, None, None))); // EMPTY
        // registry.register(Arc::new(Azure::new(client.clone(), "", None, None))); // EMPTY
